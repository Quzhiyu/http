...
import com.example.h.PullToRefreshBase.Mode;
import com.example.h.PullToRefreshBase.OnLastItemVisibleListener;
import com.example.h.PullToRefreshBase.OnRefreshListener;
import com.example.h.PullToRefreshBase.State;
...
public final class PullToRefreshListActivity extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mPullRefreshListView.setOnLastItemVisibleListener(new OnLastItemVisibleListener() {
			...
			public void onLastItemVisible() {
				Toast.makeText(PullToRefreshListActivity.this, "到头了煞笔！", Toast.LENGTH_SHORT).show();
			}
		});
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		switch (position) {
			...
			case 0:
				Toast.makeText(PullToRefreshListActivity.this, "1！", Toast.LENGTH_SHORT).show();
				break;
			case 1:
				Toast.makeText(PullToRefreshListActivity.this, "2！", Toast.LENGTH_SHORT).show();
				break;
			case 2:
				Toast.makeText(PullToRefreshListActivity.this, "3！", Toast.LENGTH_SHORT).show();
				break;
			case 3:
				Toast.makeText(PullToRefreshListActivity.this, "4！", Toast.LENGTH_SHORT).show();
				break;
			case 4:
				Toast.makeText(PullToRefreshListActivity.this, "5！", Toast.LENGTH_SHORT).show();
				break;
